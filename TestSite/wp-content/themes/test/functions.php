...
function test_register_custom_post_type() {

    register_post_type( 'attachments', array(
        'labels'             => array(
            'name'                  => esc_html__('Attachments','wayup'),
            'singular_name'         => esc_html__('Attachment','wayup'),
            'add_new'               => 'Add new',
        ),
        'public'             => true,
...
add_action( 'init', 'test_register_custom_post_type' );
